    ...
    <section id="home" className="section-hero">
      ...
      <div className="container-hero">
        ...
        <div className="container-social-icons">
          ...
          <a target="__blank" className="icon" href="https://drive.google.com/uc?export=download&id=1fgT_xB8Z0hG2yo0mi3Xs9Xa3H8AH4lfC"><Image src={cv} alt="Ícone de currículo com link para acesso ao currículo em PDF" /></a>
